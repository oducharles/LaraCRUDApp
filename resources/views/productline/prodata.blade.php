...
@if($message = Session::get('success'))
		...
		<button style=" width: 150px; margin: 10px; background-color: lightblue; text-align: center;"><a style="text-decoration:none;" href="{{route('productline.index')}}">Add Product</a></button>
